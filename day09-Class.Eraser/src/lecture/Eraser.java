...
public class Eraser {
	...
	/**
	 * 모든 필드를 초기화하는 생성자
	 * @param width : 매개변수 5개 받는 생성자로 초기화
	 * @param height: 매개변수 5개 받는 생성자로 초기화
	 * @param depth : 매개변수 5개 받는 생성자로 초기화
	 * @param layer : 매개변수 5개 받는 생성자로 초기화
	 * @param color : 매개변수 5개 받는 생성자로 초기화
	 * @param loc   : 직접초기화
	 */
	Eraser(double width, double height, double depth
