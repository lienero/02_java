...
//		this.accNumber = ++count;
	 ...
	 * 문자열로 된 계좌번호와
	 * 정수값의 잔액을 입력받아서
	 * 각각 계좌번호(accNumber)와 잔약(balance) 필드를 초기화하는
	 * 중복정의 된 생성자
	 * 
	 * 중복정의(Overloading)
	 * ------------------------------------------
...
//		value = 100;
	...
	public String withdraw(int amount) {
		...
		if (balance < amount) {
			...
			balance -= amount;
			draw = (amount +"가 출금되었습니다. 잔액은" + balance + "입니다.");
